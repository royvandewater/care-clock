...
export const Modal = ({ title, children, onClose, className }: { title: ComponentChildren; children?: ComponentChildren; onClose: () => void; className?: string }) => (
  <div class="fixed top-0 left-0 w-full h-full z-10 backdrop-blur-sm" onClick={onClose}>
    <div class="mx-auto max-w-md w-full h-full shadow-lg bg-background rounded-lg flex flex-col" onClick={(e: Event) => e.stopPropagation()}>
