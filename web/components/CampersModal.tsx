...
const RemoveButton = ({ onClick }: { onClick: (event: Event) => void }) => (
  <Button type="button" onClick={onClick} variant="danger" size="xs">
...
const NewCamperForm = ({ onAdd }: { onAdd: (name: string) => void }) => {
  ...
  return (
    <form onSubmit={onSubmit} class="flex items-end gap-4 pb-8">
